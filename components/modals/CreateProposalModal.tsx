...
import { type Proposal, type ProposalItem } from "@/types/types";
...
export function CreateProposalModal({
  ...
  const updateItem = (
    index: number,
    field: keyof Omit<ProposalItem, "id">,
    value: string | number,
  ) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[700px] w-full max-w-[95vw] max-h-[95vh] overflow-y-auto p-2 sm:p-6">
        <DialogHeader>
          <DialogTitle>Create Proposal</DialogTitle>
          <DialogDescription>
            Create a detailed proposal for a contact.
          </DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit}>
          <div className="flex flex-col gap-4 py-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-4 items-center gap-2 sm:gap-4">
              <Label htmlFor="validUntil" className="sm:text-right">
                Valid Until
              </Label>
              <Input
                id="validUntil"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-4 items-center gap-2 sm:gap-4">
              <Label htmlFor="terms" className="sm:text-right">
                Terms
              </Label>
              <Textarea
                id="terms"
          ...
          <DialogFooter className="flex flex-col sm:flex-row gap-2 sm:gap-4 mt-4">
            ...
            <Button
              type="submit"
              disabled={
                !formData.contactId || !formData.title || items.length === 0
              }
            >
              Create Proposal
            </Button>
